...
public class Car {
	// 1: 국가 2: 제작사 3: 차량구분 4: 차종 5: 세부차종 6: 차체형상 7: 안전장치
	// 8: 배기량 9: 확인란 10: 제작년도 11: 공장위치 12~17: 제작일련번호
	
	//요구사항1. car 클래스에 외부에서 필드값을 바꾸지 못하게 접근 지정자를 설정한다.
	private String VIN; // 자동차 등록 번호 17자리
	...
	//요구사항2. Car 클래스의 getter/setter/toString()을 확인한다.
